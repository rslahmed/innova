                ...
                <div class="col-lg-12 m-auto bg-light my-4 pt-2 pb-5 rounded">
                    ...
                    <form action="service_post.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group py-2">
                            <textarea name="service_text" class="form-control" rows="5" placeholder="Service Text" required></textarea>
                        </div>
                        <div class="form-group ">
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Service Image</label>
                                <input type="file" name="service_img" class="form-control-file" onchange="loadfile(event)" required>
