...
require 'db.php';
$id = $_GET['id'];
$select_data = "SELECT * FROM testis WHERE id='$id'";
            ...
            <div class="row pt-3">
                <div class="col-lg-12 m-auto bg-light my-4 pt-2 pb-5 rounded">
                    <div class="form-title text-center py-2">
                        <h2 class=""><b>Edit Testimonial</b></h2>
                    </div>
                    <form action="service_update.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group pt-2">
                            <input type="text" name="testi_title" class="form-control" placeholder="Testimonial Author" value="<?php echo $single_data['testi_title'] ?>" required>
                        </div>
                        <div class="form-group py-2">
                            <textarea name="testi_text" class="form-control" rows="5" placeholder="Testimonial Text" required><?php echo $single_data['testi_text'] ?></textarea>
                        </div>
                        <div class="form-group ">
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Testimonial Image</label>
                                <input type="file" name="testi_img" class="form-control-file" onchange="loadfile(event)">
                                <img src="uploads/testis/<?php echo $single_data['testi_img']?>"  id="preimage" width="200px" height="200px">
                            </div>
