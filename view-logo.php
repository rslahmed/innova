                ...
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <div class="card text-white bg-dark mb-3">
                            <div class="card-header"><h1 class="text-center">View Logos</h1></div>
                            ...
                            <table class="table table-dark">
                                ...
                                foreach ($select_con as $value) { ?>
                                    <tr>
                                        ...
                                        <td><img src="uploads/logos/<?php echo $value['logo_img']; ?>" alt="Profile"
                                                 style="width: 50px;"></td>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="logo_status.php?id=<?php echo $value['id']; ?>"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="delete_logo.php?id=<?php echo $value['id']; ?>"
