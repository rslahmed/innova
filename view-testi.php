...
require 'db.php';
$select_data = "SELECT * FROM testis";
                ...
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <div class="card text-white bg-dark mb-3">
                            <div class="card-header"><h1 class="text-center">View Testimonial</h1></div>
                            ...
                            <table class="table table-dark">
                                ...
                                foreach ($select_con as $value) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo substr($value['testi_title'], 0, 20) . "...."; ?></td>
                                        <td><?php echo substr($value['testi_text'], 0, 25) . "...."; ?></td>
                                        <td>
                                            <?php
                                            if ($value['status'] == '1') { ?>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="testi_status.php?id=<?php echo $value['id']; ?>"
                                        ...
                                        <td><img src="uploads/testis/<?php echo $value['testi_img']; ?>" alt="Profile"
                                                 style="width: 50px;"></td>
                                        <td>
                                            <a href="edit-testi.php?id=<?php echo $value['id'] ?>"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="delete_testi.php?id=<?php echo $value['id']; ?>"
